...
- A campaign starting within 30 days of the business's previous one drew 41% more Entrants than a first campaign and got 22% more of its viewers to enter, on the campaigns we can compare fairly (470 against 333, and 38% against 31%, n=25,947 and 5,017). A gap of 31 to 90 days did better still on Entrants. Both groups are businesses that already run giveaways constantly.
- Campaigns carrying 11 or more entry actions drew 17% more Entrants than campaigns carrying one to three (519 against 443) and got a smaller share of their viewers through, 31 of every 100 against 44. The cost of a long list lands on Conversion Rate.
- The largest group of campaigns is the smallest one, 28% at 100 to 250 Entrants, declaring a Prize pool of about 120 USD. Campaigns of 1,000 to 2,500 Entrants are 17% of the total and declared about 530 USD. Only the 10,000-plus campaigns declared 3,000. Small businesses do not need big-brand budgets.
- Start weekday makes no difference at all. December is the busiest month, 10.4% of starts against 8.3% for an even month, and its campaigns drew more Entrants and converted better, 560 at 30.8% against 492 at 26.9% overall (n=12,161). The two weeks before Christmas convert best of any week in the year at 41%, being live over Christmas made no difference to conversion against matched campaigns and New Year came with 2% worse, where the real penalty is Black Friday week at 11% worse.
...
- The top fifth of campaigns had 25 times the Impressions of the bottom fifth for a Conversion Rate two points apart (14,063 against 550, 27.7% against 25.5%). Reach separates them. History compounds too: after a campaign over 5,000 entrants, 61% of a business's next campaigns reached 5,000 again, against 12% after a smaller one.
- Advent calendars draw 22% more Entrants than the typical campaign at the second-highest share to enter of any type, 44% against cash prizes at 61%. Launches sit a little above the typical figure on Entrants, below it on Conversion Rate, and refer more. The campaigns that beat their Prize money three times over most often carried an email action, 60% of them against 43% of the rest, along with a repeatable action, a long action list and one hero Prize. A Prize under 250 USD is the one trait that runs the other way, on 33% of them against 49% of everyone else, so a cheap Prize is not what these campaigns had in common.
- Music and media businesses declared the least prize money per entrant and per address captured, and gaming the least per referred entry. Software declared the most per entrant and per address captured, though travel and events pays more per follow and per referred entry. Country Conversion Rates need care before they are read as national habits. Brazil tops the table at 59%, and its campaigns are 90% repeats that mostly run a single day, so the rate is an artifact of short automated runs and not a market. Among the countries with real volume the UK sits at 30.5% and India at 33.6%.

Every figure carries its sample size, and every finding describes what businesses chose, never what caused participation, because the dataset holds no failed campaigns to compare against. The terms the figures use (contestant, entry, conversion, clean subset, value index, uptake) are defined in [GLOSSARY.md](GLOSSARY.md). The full findings, the exclusions and the limits are in [evidence-and-limitations.md](skills/giveaway-prize-picker/references/evidence-and-limitations.md). `analysis/output/` holds the aggregate files every figure is drawn from, and the scripts that produced them are not published.
