...
- A reference that labels something as practice says so because no data backs it. Carry the label into the answer in the reader's words: "common practice, nothing in the data covers it" beside the 30 to 60 day sunset rule, rather than stating it flat. A measured answer lost marks for presenting one of these as a finding.
