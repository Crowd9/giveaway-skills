...
## What each shape is built to capture (extracted)

A concept is a promise about what the business walks away with, and the shape a business picks goes with what it
wires the campaign to collect. This is what businesses chose, so read it as the habit attached to each shape and
never as what the shape would yield for this reader.
...
|---|---|---|
| twitch follow | 35% | 14% |
| repeat business | 89% | 72% |
| 11 or more actions | 49% | 34% |
| secret code action | 27% | 13% |
| repeatable action | 56% | 47% |
| single Prize unit | 69% | 61% |
| discord join | 23% | 16% |
| collaboration in title | 20% | 14% |
| youtube visit | 47% | 43% |
| 14 days or less | 39% | 35% |
| email action | 60% | 58% |
| december start | 9% | 9% |
| own product Prize | 19% | 23% |
| question action | 9% | 12% |
| stated pool under 250 USD | 9% | 19% |
| viral share action | 48% | 59% |

Prize categories over-represented among them:

| Category | Standouts | The rest | Ratio |
|---|---|---|---|
| Tech hardware | 39% | 31% | 1.27 |
| Regulated goods (firearms) | 17% | 5% | 3.36 |
| Gift card or cash | 12% | 17% | 0.71 |
| Bundle or box | 8% | 13% | 0.59 |
| Placeholder Prize name | 6% | 4% | 1.53 |
| Game items or skins | 7% | 7% | 1.12 |
| Merch, apparel, collectibles | 4% | 4% | 1.04 |
| Home, garden, appliance | 4% | 6% | 0.59 |
| Experience, travel, tickets | 3% | 5% | 0.60 |
| Unclassified | 2% | 6% | 0.28 |
| Tools, craft, DIY | 1% | 2% | 0.79 |
| Music gear | 1% | 3% | 0.49 |
