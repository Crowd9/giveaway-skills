...
- Cash and gift cards are the default a reader reaches for, and the data does not support the reason they reach for it. Gift card or cash campaigns drew a typical 420 Entrants, below the all-campaign figure, where regulated goods drew 2,177, music gear 1,277 and tech hardware 923 (`references/prize-taxonomy.md`). Where a gift card earns its place is crowd per Prize dollar at 1.10, a little above typical for the money, and never on pulling the biggest crowd. Say so plainly when recommending one.
