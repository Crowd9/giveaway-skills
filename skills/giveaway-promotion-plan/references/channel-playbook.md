...
<!-- generated:pp_quintile_lead -->
Extracted: the top fifth of campaigns by Entrants saw a typical 14,070 Impressions against 552 for the bottom fifth, at Conversion Rates two points apart (27.6% against 25.4%). Reach is what separates them, so promotion is the lever this playbook is for. [`analysis/output/context_checks.json`, `top_vs_bottom_quintile`, 23,256 campaigns each side.]
<!-- /generated -->
...
| Group | Conversion Rate | Entries per Entrant | Entrants (typical) | Campaigns | Businesses |
|---|---|---|---|---|---|
