...
6. **Deliver** the winners, the audit summary, and what to do next (verify eligibility, contact with a deadline, keep the audit file, the input file and the exclusion file together).
